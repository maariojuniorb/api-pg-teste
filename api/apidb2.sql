...
-- Copiando estrutura do banco de dados para herculesapi
CREATE DATABASE IF NOT EXISTS `herculesapi` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `herculesapi`;

-- Copiando estrutura para tabela herculesapi.agents
...
-- Copiando dados para a tabela herculesapi.agents: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `agents` DISABLE KEYS */;
/*!40000 ALTER TABLE `agents` ENABLE KEYS */;

-- Copiando estrutura para tabela herculesapi.bikineparadisejson
...
-- Copiando dados para a tabela herculesapi.bikineparadisejson: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `bikineparadisejson` DISABLE KEYS */;
/*!40000 ALTER TABLE `bikineparadisejson` ENABLE KEYS */;

-- Copiando estrutura para tabela herculesapi.butterflyblossomplayerjson
...
-- Copiando dados para a tabela herculesapi.butterflyblossomplayerjson: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `butterflyblossomplayerjson` DISABLE KEYS */;
/*!40000 ALTER TABLE `butterflyblossomplayerjson` ENABLE KEYS */;

-- Copiando estrutura para tabela herculesapi.calls
...
-- Copiando dados para a tabela herculesapi.calls: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `calls` DISABLE KEYS */;
/*!40000 ALTER TABLE `calls` ENABLE KEYS */;

-- Copiando estrutura para tabela herculesapi.fortunedragonplayerjson
...
-- Copiando dados para a tabela herculesapi.fortunedragonplayerjson: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `fortunedragonplayerjson` DISABLE KEYS */;
/*!40000 ALTER TABLE `fortunedragonplayerjson` ENABLE KEYS */;

-- Copiando estrutura para tabela herculesapi.fortunemouseplayerjson
...
-- Copiando dados para a tabela herculesapi.fortunemouseplayerjson: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `fortunemouseplayerjson` DISABLE KEYS */;
/*!40000 ALTER TABLE `fortunemouseplayerjson` ENABLE KEYS */;

-- Copiando estrutura para tabela herculesapi.fortuneoxrplayerjson
...
-- Copiando dados para a tabela herculesapi.fortuneoxrplayerjson: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `fortuneoxrplayerjson` DISABLE KEYS */;
/*!40000 ALTER TABLE `fortuneoxrplayerjson` ENABLE KEYS */;

-- Copiando estrutura para tabela herculesapi.fortunerabbitplayerjson
...
-- Copiando dados para a tabela herculesapi.fortunerabbitplayerjson: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `fortunerabbitplayerjson` DISABLE KEYS */;
/*!40000 ALTER TABLE `fortunerabbitplayerjson` ENABLE KEYS */;

-- Copiando estrutura para tabela herculesapi.fortunetigerplayerjson
...
-- Copiando dados para a tabela herculesapi.fortunetigerplayerjson: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `fortunetigerplayerjson` DISABLE KEYS */;
/*!40000 ALTER TABLE `fortunetigerplayerjson` ENABLE KEYS */;

-- Copiando estrutura para tabela herculesapi.users
...
-- Copiando dados para a tabela herculesapi.users: ~0 rows (aproximadamente)

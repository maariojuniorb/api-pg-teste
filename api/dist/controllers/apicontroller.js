                ...
                if (user.length === 0) {
                    ...
                    if (createnewuser.affectedRows >= 1) {
                        ...
                        res.send({
                            status: 1,
                            msg: "SUCCESS",
                            launch_url: `https://api.playflare-bet.site/${codegame}/index.html?operator_token=Zm9saWFiZXQ=&btt=1&t=${getnewuser[0].token}&or=api.playflare-bet.site&api=api.playflare-bet.site`,
                    ...
                    res.send({
                        status: 1,
                        msg: "SUCCESS",
                        launch_url: `https://api.playflare-bet.site/${codegame}/index.html?operator_token=Zm9saWFiZXQ=&btt=1&t=${user[0].token}&or=api.playflare-bet.site&api=api.playflare-bet.site`,
